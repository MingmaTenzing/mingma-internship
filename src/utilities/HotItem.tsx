  ...
  return (
    <div>
        ...
        <div className="overflow-hidden ">
          ...
          <Image src={item.nftImage} alt="author thumbnail" width={400} height={200} className='hover:scale-110 transition-all ease-linear duration-500  '  />
        </div>
          
    
    <div className="absolute  bottom-20 left-1/2 transform -translate-x-1/2 flex flex-col ">
          <Image src={item.authorImage} alt="author thumbnail" width={200} height={200} className=' rounded-full w-14 border-4 border-white '/>
