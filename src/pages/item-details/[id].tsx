...
function ItemDetails() {
  ...
  return (
    <div>
      <Nav />
      {loading ? (
        <div className="mt-20 md:mt-[140px]">
          {" "}
          <ItemDetailsLoading />
        </div>
      ) : (
          ...
          <div className="space-y-4 mt-4 md:mt-0 lg:w-[600px]">
            ...
            <div className="flex space-x-2">
              <div className="flex text-gray-500 justify-center items-center space-x-2 bg-purple w-[80px] px-2 py-1 bg-opacity-20">
                ...
                <p className="text-sm">{nftDetails?.views}</p>
              </div>
              <div className="flex text-gray-500 justify-center items-center space-x-2 bg-purple w-[80px] px-2 py-1 bg-opacity-20">
                <HeartIcon className="w-4" />{" "}
                <p className="text-sm">{nftDetails?.likes}</p>
              </div>
            </div>
            ...
            <div className="space-y-4 pb-2">
              ...
              <div className="flex items-center space-x-5">
                <div className="relative z-10">
                  <Image onClick={() => router.push(`/author/${nftDetails?.ownerId}`)}
                ...
                <div>
                  <p onClick={() => router.push(`/author/${nftDetails?.ownerId}`)} className="font-bold hover:text-purple cursor-pointer">
            ...
            <div className="space-y-4 pb-2">
              ...
              <div className="flex items-center space-x-5">
                <div className="relative z-10">
                  <Image
                  onClick={() => router.push(`/author/${nftDetails?.creatorId}`)}
                ...
                <div>
                  <p onClick={() => router.push(`/author/${nftDetails?.creatorId}`)} className="font-bold hover:text-purple cursor-pointer">
